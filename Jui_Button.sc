Jui_Button : UserView {
	...
	*new { | parent, bounds |
	...
	displayState_ {|type|
		...
		{true}{("QGui_Button displayState_(%) not define, use [\\on, \\onOver, \\off, \\offOver]".format(type)).warn};
	}

	iconName{|name|
		iconPath = super.class.filenameSymbol.asString.dirname +/+ "Icons" +/+ name ++ ".png";
